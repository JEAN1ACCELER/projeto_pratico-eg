...
* **Controle de Presença:** Registro de check-in em reuniões de projeto diretamente pelo aplicativo, substituindo as listas de papel.
...
A documentação técnica do projeto é organizada na pasta `especificacao/`, seguindo os padrões da disciplina:
