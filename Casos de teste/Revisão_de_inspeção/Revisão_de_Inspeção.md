...
* **Problema:** Uso de termo subjetivo "carregar rápido em conexão de boa qualidade".
* **Diagnóstico:** Requisitos não-funcionais devem ser testáveis e automatizáveis.
* **Correção:** Substituído por SLA de tempo de resposta máximo de **3 segundos** sob rede de 10 Mbps.
